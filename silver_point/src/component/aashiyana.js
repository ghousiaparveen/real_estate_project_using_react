    ...
    return(
        <div>
            <div className="as1">
                ...
                <p className="para">
                Nestled in a prime location, Aashiyana is the 
        ...
        Aashiyana stands as a testament to luxurious yet
        affordable living.
                </p>
                <h2 className="title">Exclusive Bank Loan Facilities</h2>
        <p className="para">At Aashiyana, we understand the importance of financial 
